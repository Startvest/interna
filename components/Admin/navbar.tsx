...
type pathNames = '/admin/dashboard' | '/admin/moderation' | '/admin/logs' | '/admin/settings';
...
export function NavigationBar(){
     ...
     return(
          <div className={styles.navbar}>
               <Image src="/assets/logo-white.svg" className={styles.logo} height={'50px'} width={'222px'}/>
               <h3>Admin Panel</h3>
